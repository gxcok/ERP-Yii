            ...
            <div class="col-md-4">
                <div class="form-group field-dtoa_ticket_cart">
                    ...
                    <select id="ticketcart-c_id" class="form-control" name="DtoaTicketCart[c_id]" disabled>
                        <option value="<?=$ticket_model['c_id']?>"><?=$ticket_model['c_name']?></option>
                    </select>
                    <div class="help-block"></div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="j_price_item" name="DtoaTicketCart[j_price]"
                           value="<?=$ticket_model['j_price']?>" readonly>
                    <div class="help-block"></div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                ...
                <select name="DtoaTicketCart[use_style]" id="use_style" class="form-control" disabled>
                    <option value="<?=$ticket_model['use_style']?>"><?=DtoaTicketCart::USE_STYLE[$ticket_model['use_style']]?></option>
                </select>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="DtoaTicketCart[use_date]" id="ticketcart-use_date"
                           value="<?=$ticket_model['use_date']?>" readonly>
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-md-4">
                    ...
                    <select name="DtoaTicketCart[hc_grade]" id="hc_grade" class="form-control" disabled>
                        <option value="<?=$ticket_model['hc_grade']?>"><?=DtoaTicketCart::HC_GRADE[$ticket_model['hc_grade']]?></option>
                    </select>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="DtoaTicketCart[ticket_num]" id="ticket_num" value="<?=$ticket_model['ticket_num']?>" readonly>
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="DtoaTicketCart[use_place]" id="use_place" value="<?=$ticket_model['use_place']?>" readonly>
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control num_check" name="DtoaTicketCart[pour_num]"
                           value="<?=$ticket_model['pour_num']?>" id="pour_num" readonly>
...
<div id="print_box" style="display: none;margin:0;padding: 10px;font-size: 12px;">
    ...
    <table class="table table-bordered table-condensed" id="print_cart" style="font-size: 12px;z-index:999;">
    </table>
</div>
