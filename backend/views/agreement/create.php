...
<div class="dtoa-agreement-create">
    <div class="dtoa-agreement-form" style="">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group field-dtoaagreement-s_id required">
	<span style="width:80px;text-align: right; display: inline-block;margin-right: 5px;">
		<label class="control-label" for="dtoaagreement-s_id">供应商</label></span>
                    <select name="DtoaAgreement[s_id]" data-placeholder="请选择供应商" data-no_results_text="没有找到供应商:"
                            id="dtoaagreement-s_id" class="form-control supplier_select">
                        <option value=""></option>
            ...
            <div class="col-md-4">
                <?= $form->field($model, 'h_no')->textInput(['readonly' => 'true','value'=>DtoaAgreement::getno()]) ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <?=$form->field($model, 'h_type')->dropdownList(DtoaAgreement::AGREEMENT_TYPE)?>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <?= $form->field($model, 'h_info')->textarea(['maxlength' => true,'rows' => 1]) ?>
                <?= $form->field($model, 'h_status')->hiddenInput(['readonly' => 'true','value'=>0])->label(false)?>
        ...
        <div class="text-center">
            <?= Html::Button('保存', ['class' => 'btn btn-success agreement-create-save']) ?>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
...
<script>
    $(function(){
        ...
        $(".agreement-create-save").bind('click',function(){
            if($("#dtoaagreement-s_id").val()==''){
                layer.msg('请选择供应商', {icon: 6});
            }else{
                $("#dtoaagreement-g_id").attr('disabled',false);
                $("#dtoaagreement-next_admin_id").attr('disabled',false);
                $("#agreement-create").submit();
            }
        });
    });
    var date = new Date();
