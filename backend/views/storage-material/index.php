...
<script type="text/javascript">
    ...
    var m = meTables({
        ...
        number: false,
        pk: "k_id",
        params:{'g_id':'<?=Yii::$app->session['g_id']?>','k_type':1},
        table: {
            columns: [
					{
						title: "入库ID",
    ...
    */
    ...
    $(document).on("click", "#show-table-add", function () {
        parent.addIframe(GetRandomNum(1000,100000),'/storage-material/create','添加材料入库');
    });
    ...
    $(document).on("click", ".me-table-view-show-table", function () {
        ...
        // 自定义处理逻辑
        //console.log(data);
        parent.addIframe(GetRandomNum(1000,100000),'/storage-material/view?id='+data['k_id'],'查看材料入库');
    });
    ...
    $(document).on("click", ".me-table-more-show-table", function () {
        ...
        // 自定义处理逻辑
        //console.log(data);
        parent.addIframe(GetRandomNum(1000,100000),'/storage-material/update?id='+data['k_id'],'更新材料入库');
    });
