...
<style>
    ...
    input.storage_ok_item{width:18px !important;height: 18px !important; margin-left: 5px;margin-top:5px;}
            ...
            solid #ddd;">
                ...
                <?php foreach ($storagecart as $k => $cart) { ?>
                    <tr data-sc_id="<?=$cart['sc_id']?>">
                        ...
                        <td><?=floatval($cart['j_real_price'])?></td>
...
if($.inArray(head[i].k_name,['total_price','j_num','j_price','mul_price', 'j_real_num','j_real_price','pour_num','lease_time','real_time'])
    !=-1){
