...
<div class="dtoa-plan-create">
    <div class="dtoa-plan-form" style="">
        ...
        <div class="row">
            <div class="col-md-4">
                <?=$form->field($model, 'g_id')->dropdownList([Yii::$app->session['g_id']=>DtoaProject::findOne(Yii::$app->session['g_id'])['g_name']])?>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <?= $form->field($model, 'j_no')->textInput(['readonly' => 'true','value'=>DtoaPrePlan::getno()]) ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <?=$form->field($model, 'next_admin_id')->dropdownList([$next_admin_id=>$user[$next_admin_id]])?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
...
<script>
    $(function(){
        ...
        $(".plan-create-save").bind('click',function(){
            $("#dtoapreplan-g_id").attr('disabled',false);
